...
function initializeTestimonials() {
  ...
  testimonialData.map((testimonial) =>
    collection.insertAdjacentHTML(
      ...
      `<div class="testimonial">
        ...
        <h3 class="author">${testimonial.author}<span class="city">${testimonial.city}</span></h3>
      </div>`
    )
  )
  ...
  collection.insertAdjacentHTML(
    ...
    `<div class="testimonial">
      ...
      testimonialData[testimonialData.length - 1].city
    }</span></h3>
      </div>`
  )
  ...
  collection.insertAdjacentHTML(
    ...
    `<div class="testimonial">
        ...
        <h3 class="author">${testimonialData[0].author}<span class="city">${testimonialData[0].city}</span></h3>
      </div>`
  )
}
